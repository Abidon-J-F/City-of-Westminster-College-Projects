Public Class AccountClass
    ...
    'procedures (subroutines in VBasic) set values of private data
    ...
    End Sub
    Public Sub setAccountNo(ByVal pAccountNo As Integer)
        accountNo = pAccountNo
    End Sub
    Public Sub setBalance(ByVal pTransaction As Decimal)
        balance = balance + pTransaction
    End Sub
    Public Sub setlimit(ByVal plimit As Decimal)
